...
![Wire types](images/wire-types.jpg =250x)
...
![Good breadboard](images/good-circuit.jpeg =250x)

![Bad breadboard](images/bad-circuit.jpeg =250x)
...
![Wire strippers](images/wire-strippers.jpg =250x)
...
![Breadboard clip](images/clips.png =250x)

![Breadboard internals](images/breadboard-internals.png =250x)
...
![Breadboard internal connections](images/breadboard-connections.png =250x)
